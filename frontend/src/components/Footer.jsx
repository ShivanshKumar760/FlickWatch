...
export default function Footer() {
  const socials = [
    ...
    {
      href: "https://linkedin.com/in/aman-singh123",
      name: "LinkedIn",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
  ...
  return (
    <>
      <footer className="flex lg:flex-row flex-col items-end justify-between lg:gap-28 gap-6 lg:p-10 p-6 bg-black">
        <div className="basis-1/3 space-y-2">
          ...
          Experience the magic of cinema with our movie site. Discover, watch, and explore a vast library of films powered by the TMDB API and streamed seamlessly through VidSrc.
          </p>
        </div>
